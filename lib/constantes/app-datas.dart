...
List<TrainingData> trainingData = [
  ...
  TrainingData(
      ...
      certifications: [
        CertificationData(name: "B0L;", description: ""),
  ...
  TrainingData(
      ...
      description:
          "'La formation ATEX sensibilise au risque lié aux atmosphères explosives. Elle couvre les dangers potentiels, les réglementations en vigueur, et les mesures de prévention essentielles. Les participants apprennent à identifier les zones à risque, à utiliser les équipements de protection appropriés et à mettre en place des procédures de sécurité pour éviter les accidents. Cette formation est cruciale pour assurer la sécurité des employés et la conformité légale des entreprises opérant dans des environnements à risque d'explosion.",
      certifications: []),
  TrainingData(
      trainingName: "SST (Sauvetage secourisme du travail)",
      trainingImagePath: "assets/images/image_sst.webp",
      description: "la prévention des risques professionnels. Les participants apprennent à évaluer les situations d'urgence, à effectuer les gestes de secours nécessaires et à alerter les secours. Elle est essentielle pour assurer la sécurité des employés et minimiser les conséquences des accidents au travail.",
      certifications: []),
  TrainingData(
      trainingName: "Manutentions manuelles: Gestes et postures",
      description: "La formation SST (Sauvetage Secourisme du Travail) enseigne les techniques de premiers secours et la prévention des risques professionnels. Les participants apprennent à évaluer les situations d'urgence, à effectuer les gestes de secours nécessaires et à alerter les secours. Elle est essentielle pour assurer la sécurité des employés et minimiser les conséquences des accidents au travail.",
